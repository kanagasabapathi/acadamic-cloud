...
public class MyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   out.println("<html>");
	  out.println("<h1>Cloud Students Details</h1>");
	  out.println("<body>");
	  out.println("<div style='margin-left:200px'>");
	 out.println("<p>");
	 out.println("<table style='background-color:azure'>");
	...
	out.println("</div>");
	out.println("<div style='margin-left:160px'><a href='index.jsp'>Go back and add more Students</a></div>");
	out.println("</body>");
	out.println("</html>");
	}
